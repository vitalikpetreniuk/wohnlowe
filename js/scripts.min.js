...
$(function () {
    ...
    $('.valuation-category-button').on('click', function () {
        $('.calc-inside').addClass('with-calc');
        $('.calc').addClass('open');
        var target = $(this).attr('data-target');
        $('.calc-block[data-id=' + target + ']').addClass('active').siblings().removeClass('active');
        if($('.calc-block.active .calc-screen.active .choose-buttons').length){
